...
def add_RSKT_seg_config(cfg):
    ...
    # rotate
    cfg.MODEL.SEM_SEG_HEAD.USE_ROTATE = True
    # clip_remote
    cfg.MODEL.SEM_SEG_HEAD.USE_REMOTE_CLIP = True
    cfg.MODEL.SEM_SEG_HEAD.CLIP_REMOTE_FINETUNE = "freeze"
    cfg.MODEL.SEM_SEG_HEAD.CLIP_PRETRAINED_WEIGHTS = "pathtovit"
    cfg.MODEL.SEM_SEG_HEAD.CLIP_PRETRAINED_REMOTE =  "ViT-B-32" 
    cfg.MODEL.SEM_SEG_HEAD.CLIP_PRETRAINED_WEIGHTS_REMOTE = "pathtoremotevit"
    # dino
    cfg.MODEL.SEM_SEG_HEAD.USE_REMOTE_DINO = True
    ...
    cfg.MODEL.SEM_SEG_HEAD.USE_EFFICIENT = True
